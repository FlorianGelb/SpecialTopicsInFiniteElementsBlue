...
#ifndef LAPLACIAN_ELASTICITY_H
#define LAPLACIAN_ELASTICITY_H
// stolen from https://github.com/mwichro/SpecialTopicsFEM/blob/main/include/elasticity.h
// ---------------------------------------------------------------------
//
...
{
public:
  Elasticity(Triangulation<dim> &tria, const unsigned int degree);
