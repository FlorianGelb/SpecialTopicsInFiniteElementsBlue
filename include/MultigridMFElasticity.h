//
// Created by Florian on 28.12.2024.
//


#ifndef LAPLACIAN_MULTIGRIDMFELASTICITY_H
#define LAPLACIAN_MULTIGRIDMFELASTICITY_H
...
class MultigridMFElasticity
{
public:
  MultigridMFElasticity();
  void run();
...
template <int dim, int degree, int n_components>
MultigridMFElasticity<dim, degree, n_components>::MultigridMFElasticity()
#ifdef DEAL_II_WITH_P4EST
...
template <int dim, int degree, int n_components>
void MultigridMFElasticity<dim, degree, n_components>::setup_system()
{
  Timer time;
  setup_time = 0;
...
template <int dim, int degree, int n_components>
void MultigridMFElasticity<dim, degree, n_components>::assemble_rhs()
{
  Timer time;

  system_rhs = 0;
  FEEvaluation<dim, degree> phi(
...
template <int dim, int degree, int n_components>
void MultigridMFElasticity<dim, degree, n_components>::output_results(const unsigned int cycle) const
{
  Timer time;
...
template <int dim, int degree, int n_components>
void MultigridMFElasticity<dim, degree, n_components>::run()
{
  {
...
#endif // LAPLACIAN_MULTIGRIDMFELASTICITY_H
